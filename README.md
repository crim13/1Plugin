...
Versiunea curenta din acest repo este `2.9.79`.
...
Modulele sunt incarcate doar daca Divi 5 este disponibil si daca sunt activate din setarile pluginului. Pentru update-uri de la 2.8, extensia FAQ si modulul FAQ pornesc dezactivate si pot fi activate explicit din setari.
...
3. Construieste `1plugin-light.zip` cu structura flat folosita de release-urile 2.8: `1plugin-light.php`, `includes/`, `assets/` si `modules/` direct la radacina arhivei.
