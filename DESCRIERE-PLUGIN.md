...
Versiunea curenta din repo este `2.9.72-dev`, definita atat in header-ul pluginului din `1plugin-light.php`, cat si in constanta `ONEPLUGIN_LIGHT_VERSION`.
...
- transparent fixed header pentru headerul Divi/custom gestionat;
...
Arhivele de release din root sunt `1plugin-light.zip` si arhiva versionata `1plugin-light-<versiune>-dev.zip`, generate doar din fisiere runtime.
