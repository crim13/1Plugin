...
final class OnePlugin_Light_Divi5_Menu_Server {
                ...
                $style_args['styleProps'] = [
                    'advancedStyles' => [
                        [
                            ...
                            'props' => [
                                'attr' => $args['attrs']['submenuIndicator']['advanced']['color'] ?? [],
                                'property' => 'color',
                            ],
                        ],
                        [
    ...
    private static function flatten_menu_props($attrs) {
        ...
        $layout = self::get_menu_setting_value($menu_settings, 'layout', 'horizontal');
        $align = self::get_menu_setting_value($menu_settings, 'align', 'center');
        ...
        $toggle_label = self::get_menu_setting_value($menu_settings, 'toggleLabel', 'Menu');
        ...
        $toggle_background_color = self::get_menu_setting_value($menu_settings, 'toggleBackgroundColor', '#ffffff');
        ...
        $menu_gap = self::get_menu_setting_value($menu_settings, 'menuGap', '24');
