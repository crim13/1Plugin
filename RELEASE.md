...
4. Confirm `1plugin-light.php` inside the ZIP has the intended final version.
...
2. Push the commit.
3. Create the final stable tag on that commit.
4. Create a GitHub release for the final stable tag.
5. Upload exactly one updater asset named `1plugin-light.zip`.
6. Publish it as a stable release and mark it as Latest.
7. Verify GitHub latest release returns the final stable tag.
...
3. Confirm WordPress sees the final stable version.
